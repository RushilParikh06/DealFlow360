...
describe('warehouse split', () => {
    it('ships from one warehouse when one warehouse can cover it', () => {
        const r = (0, allocation_1.chooseAllocation)('ord_1', [{ productId: 'prd_1', qty: 20 }], stock, 'INR');
    ...
    it('reproduces the split from plan.md section 8', () => {
        const r = (0, allocation_1.chooseAllocation)('ord_1', [{ productId: 'prd_1', qty: 24 }], stock, 'INR');
    ...
    it('backorders only the uncovered remainder', () => {
        const r = (0, allocation_1.chooseAllocation)('ord_1', [{ productId: 'prd_1', qty: 40 }], stock, 'INR');
    ...
    it('says so plainly when nobody stocks the product', () => {
        const r = (0, allocation_1.chooseAllocation)('ord_1', [{ productId: 'prd_ghost', qty: 5 }], stock, 'INR');
        expect(r.allocations).toEqual([]);
    ...
    it('never double spends the same shelf across two lines', () => {
        ...
        const r = (0, allocation_1.chooseAllocation)('ord_1', [{ productId: 'prd_1', qty: 5 }, { productId: 'prd_2', qty: 7 }], shared, 'INR');
    ...
    it('breaks a stock tie on the cheaper shipment', () => {
        ...
        const r = (0, allocation_1.chooseAllocation)('ord_1', [{ productId: 'prd_1', qty: 6 }], tied, 'INR');
    ...
    it('treats negative available stock as zero rather than inventing units', () => {
        ...
        const r = (0, allocation_1.chooseAllocation)('ord_1', [{ productId: 'prd_1', qty: 2 }], broken, 'INR');
        expect(r.allocations).toEqual([]);
        expect(r.backorder[0].qty).toBe(2);
    });
});
//# sourceMappingURL=allocation.spec.js.map