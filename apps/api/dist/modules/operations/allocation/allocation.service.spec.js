...
describe('recommendAllocation', () => {
    it('prefers the cheapest warehouse first, splits only what it must', () => {
        ...
        const result = (0, allocation_service_1.recommendAllocation)([{ productId: 'prd_1', qty: 24 }], stock);
    ...
    it('a single warehouse covering the whole line needs one shipment', () => {
        const result = (0, allocation_service_1.recommendAllocation)([{ productId: 'prd_1', qty: 3 }], stock);
    ...
    it('demand exceeding every warehouse combined goes to backorder', () => {
        const result = (0, allocation_service_1.recommendAllocation)([{ productId: 'prd_1', qty: 100 }], stock);
    ...
    it('two lines for the same product do not double-spend one warehouse row', () => {
        const result = (0, allocation_service_1.recommendAllocation)([{ productId: 'prd_1', qty: 5 }, { productId: 'prd_1', qty: 5 }], stock);
...
//# sourceMappingURL=allocation.service.spec.js.map